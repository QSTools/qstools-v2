    ...
    <>
        ...
        <div className="ui-panel">
          <div className="ui-split">
            <div>
              ...
              <h2 className="ui-card-title-sm">Opening Hours</h2>
              <p className="ui-help">
      ...
      <section className="ui-section">
        <div className="ui-panel">
          ...
          <h3 className="ui-card-title-sm">Normal operating pattern</h3>

          <p className="ui-help">
            Set the normal weekly operating pattern. This creates calendar
            context only.
          </p>
          ...
          {(standard_week_days || []).some((day) => day.invalid_time_range) && (
            <p className="ui-help">
              One or more days has an invalid time range. Close time must be
              after open time.
            </p>
          )}
        </div>
      ...
      <section className="ui-section">
        <div className="ui-panel">
          ...
          <h3 className="ui-card-title-sm">Shutdowns and holidays</h3>
        ...
        <div className="ui-panel">
          <div className="ui-split">
            <div>
              ...
              <h3 className="ui-card-title-sm">Additional closed days</h3>
              <p className="ui-help">
                Use this for specific shutdowns or closures that reduce
      ...
      <section className="ui-section">
        <div className="ui-panel">
          ...
          <h3 className="ui-card-title-sm">How opening hours are used</h3>
      ...
      <section className="ui-section">
        <div className="ui-panel">
          ...
          <h3 className="ui-card-title-sm">Warnings</h3>
