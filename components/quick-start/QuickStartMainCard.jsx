  ...
  return (
    <label className="ui-stack">
      ...
      <input
        ...
        value={value ?? ""}
        onChange={(event) =>
          update_quick_start_field(field_name, event.target.value)
        }
      />
    </label>
  );
      ...
      <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
        <div className="ui-panel ui-stack">
          <div className="ui-stack">
            ...
            <h1>Do your quotes reflect your business model?</h1>
            <p className="ui-help">
        ...
        <div className="ui-panel ui-stack items-center text-center">
          ...
          <div className="ui-stack pt-4">
            <p className="ui-help">This is what’s left to run your business.</p>
