...
function getDriverMessage(biggestDriver) {
  ...
  return `Biggest impact: ${biggestDriver.shortLabel} (${formatDelta(
    biggestDriver.delta
  )}/hr)`;
}
        ...
        {showHelp ? (
          <div className="ui-panel mt-5">
            ...
            <div className="ui-help mt-3 leading-6">
              ...
              <br />
              <strong>Productivity ↑</strong> → Cost per hour drops → Profit
              improves
              <br />
          ...
          <div className="mt-4 space-y-3">
            <DeltaRow
              ...
              scenarioValue={Number(
                scenarioOutputs.productive_labour_cost_rate ?? 0
              )}
            ...
            <DeltaRow
              ...
              scenarioValue={Number(
                scenarioOutputs.minimum_charge_out_rate ?? 0
              )}
