    ...
    <section className="rounded-2xl border border-neutral-800 bg-neutral-900 p-5">
      ...
      <div className="space-y-4">
        ...
        <Block title="2. Annual Cost">
          ...
          <Row label="Employer Costs" value={fmtCur(outputs.total_employer_contribution_cost)} />
        ...
        <Block title="3. Cost per Productive Hour">
          ...
          <Result label="True Cost per Hour" value={fmtCur(outputs.productive_labour_cost_rate)} />
        </Block>

        <Block title="4. Required Charge-Out Rate">
          <Row label="True Cost per Hour" value={fmtCur(outputs.productive_labour_cost_rate)} />
