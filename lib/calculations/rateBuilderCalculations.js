...
export function calculateRateBuilderRecoveryPreview({
  ...
  const selected_recovery_cost = round_currency(
    safe_selected_recovery_rate * safe_output_driver_quantity
  );
  ...
  const recovery_cost_per_output_unit = safe_selected_recovery_rate;
  ...
  if (safe_total_charge > 0 && safe_selected_recovery_rate > 0) {
    recovery_status =
