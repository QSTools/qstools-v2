...
export function build_cost_allocation_inputs({
  ...
  return {
    ...
    total_people_cost_annual: safe_number(
      recovery_outputs?.total_people_cost_annual
    ),
    total_asset_cost_annual: safe_number(
      recovery_outputs?.total_asset_cost_annual
    ),
    total_business_overheads: safe_number(
      recovery_outputs?.total_business_overheads
    ),
