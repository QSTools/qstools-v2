...
function slugify_labour_type_id(value = "") {
  return (
...
function format_labour_type_label(value = "") {
...
function get_productive_labour_type_key(staff = {}) {
...
function get_staff_productive_hours(staff = {}) {
  return to_number(
    staff?.productive_hours_annual ?? staff?.recovery_hours ?? staff?.productive_hours
  );
}

function get_staff_recovery_rate(staff = {}) {
...
function build_productive_labour_types(active_staff = []) {
...
export function buildLabourOutputContract({
  ...
  const total_recovery_hours = sum_staff_value(
    active_staff,
    "recovery_hours"
  );
