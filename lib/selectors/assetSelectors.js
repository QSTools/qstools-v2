...
export function buildAssetStatus({
  ...
  if (!has_positive_number(asset_state.assets_benchmark_total)) {
      ...
      reconciliation_rows: [
        {
          ...
          value: format_currency(calculations.assets_benchmark_total),
        },
        {
          label: "Module Total",
          value: format_currency(calculations.module_total_asset_cost_annual),
        },
        {
          label: "Variance Amount",
          value: format_currency(calculations.assets_variance_amount),
        },
        {
          label: "Variance Percent",
          value: format_percent(calculations.assets_variance_percent),
        },
        {
          label: "Reconciliation",
          value: get_reconciliation_label(calculations.reconciliation_state),
          emphasis: true,
        },
      ],
      meta: {
