  ...
  return {
    items: [
      ...
      },
      {
        ...
        value: format_number(output_contract.total_business_costs),
        tone: output_contract.total_business_costs > 0 ? "good" : "warn",
      },
      {
        label: "Unassigned",
        value: format_number(output_contract.unassigned_balance),
        tone: output_contract.unassigned_balance === 0 ? "good" : "bad",
      },
      {
        label: "Ready",
        value: output_contract.pnl_ready ? "Yes" : "No",
        tone: output_contract.pnl_ready ? "good" : "bad",
      },
      {
        label: "Warnings",
