...
function build_recovery_fields({
  ...
  const total_business_overheads = round_currency(
    recovery_row?.total_business_overheads ??
      cost_allocation_output?.total_available_overhead_cost ??
      cost_allocation_output?.total_grouped_overhead_cost ??
      cost_allocation_output?.overhead_absorbed_cost ??
      cost_allocation_output?.recovery_plan?.overhead_absorbed_cost ??
      0
  );
