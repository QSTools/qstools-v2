...
function is_business_summary_trusted(calculated = {}) {
...
function is_labour_recovery_clean(calculated = {}) {
...
function is_asset_recovery_clean(calculated = {}) {
...
function is_material_recovery_clean(calculated = {}) {
  if (
