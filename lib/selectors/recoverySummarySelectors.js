...
export function buildRecoverySummaryCard({
  ...
  return {
    ...
    suggested_labour_share_percent: calculated.suggested_labour_share_percent,
    suggested_asset_share_percent: calculated.suggested_asset_share_percent,
    ...
    on_recovery_model_change: (value) => {
      ...
      if (next_recovery_model === "hybrid") {
        update_recovery_field(
          "labour_share_percent",
          calculated.suggested_labour_share_percent ?? 50
        );
        update_recovery_field(
          "asset_share_percent",
          calculated.suggested_asset_share_percent ?? 25
        );
        update_recovery_field(
          "material_share_percent",
          calculated.suggested_material_share_percent ?? 25
        );
      }
    },
    ...
    on_reset: () => {
      ...
      update_recovery_field(
        "labour_share_percent",
        calculated.suggested_labour_share_percent ?? 100
      );
      update_recovery_field(
        "asset_share_percent",
        calculated.suggested_asset_share_percent ?? 0
      );
      update_recovery_field(
        "material_share_percent",
        calculated.suggested_material_share_percent ?? 0
      );
    },
  };
}
