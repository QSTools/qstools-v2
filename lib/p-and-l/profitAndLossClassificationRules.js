...
export function infer_direct_cost_category_id(line_name = "") {
  ...
  if (
    normalized.includes("subcontracting - general") ||
    normalized.includes("subcontracting general") ||
    normalized.includes("concrete laying") ||
    normalized.includes("concrete pumping") ||
    normalized.includes("pumping") ||
    normalized.includes("blocklaying") ||
    normalized.includes("bricklaying") ||
    normalized.includes("reinforcing") ||
    normalized.includes("waterproofing") ||
    normalized.includes("cutting") ||
    normalized.includes("sawing") ||
    normalized.includes("drilling") ||
    normalized.includes("scaffold") ||
    normalized.includes("scaffolding")
  ) {
    return "subcontracting_general";
  }
