...
export function get_operating_expense_group_key(line) {
  ...
  const review_subcategory = line.review_subcategory ?? "";

  // Saved classification must win first.
  // This prevents name-based fallback rules from forcing manually assigned
  // rows back into Other / Unallocated.
...
const OPERATING_EXPENSE_GROUPS = [
  ...
  },
  {
    ...
    help: "Accounting, bookkeeping, legal, and finance administration.",
    defaultOpen: false,
  },
  {
    key: "finance_interest",
    title: "Finance / Interest",
    help: "Bank interest, loan interest, overdraft interest, and finance costs. These feed General Overheads unless later reviewed as asset finance.",
    defaultOpen: false,
  },
  {
  ...
  },
  {
    key: "travel",
    title: "Travel",
    help: "Travel, mileage, accommodation, and business travel costs that feed General Overheads.",
    defaultOpen: false,
  },
  {
    key: "excluded_items",
  ...
  },
  {
    ...
    help: "Unusual costs and lines that still need review.",
    defaultOpen: false,
  },
];
