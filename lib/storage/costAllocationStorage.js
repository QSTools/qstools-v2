...
function get_storage_state() {
  ...
  try {
    ...
    return {
      ...
      labour_group_assignments: Array.isArray(parsed?.labour_group_assignments)
        ? parsed.labour_group_assignments
        : [],

      asset_group_assignments: Array.isArray(parsed?.asset_group_assignments)
        ? parsed.asset_group_assignments
        : [],

      overhead_group_assignments: Array.isArray(
        parsed?.overhead_group_assignments
      )
        ? parsed.overhead_group_assignments
        : [],
    };
