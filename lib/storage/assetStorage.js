...
function sanitizeSavedAssetRecord(input = {}) {
  ...
  return {
    ...sanitized,
    finance_end_date: input.finance_end_date || "",
    finance_active: Boolean(input.finance_active),
    finance_status: input.finance_status || "not_financed",
    principal_annual: Number(input.principal_annual || 0),
    interest_annual: Number(input.interest_annual || 0),
