...
export default function useRecoverySummary(inputs = {}) {
  ...
  const output_contract = useMemo(() => {
    return {
      ...
      product_unit_label: calculated.product_unit_label,
      product_unit_type: calculated.product_unit_type,
      product_unit_type_label: calculated.product_unit_type_label,
      product_unit_margin_label: calculated.product_unit_margin_label,
      product_required_cost_label: calculated.product_required_cost_label,
      product_surplus_gap_label: calculated.product_surplus_gap_label,
      product_total_units_label: calculated.product_total_units_label,
